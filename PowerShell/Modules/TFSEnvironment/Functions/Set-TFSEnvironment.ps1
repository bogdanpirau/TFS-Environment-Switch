...
(
	...
	Set-TFSEnvPathsFileContent $DevApi $DevWeb $MainApi $MainWeb $RelApi $RelWeb $HotApi $HotWeb
	...
	Set-TFSMachineEnvVariable $TFSEnvName $DevApi $DevWeb $MainApi $MainWeb $RelApi $RelWeb $HotApi $HotWeb
	Use-TFSEnvironment
